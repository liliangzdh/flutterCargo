...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case UserInfoEntity:
			...
			return userInfoSpUserAuthFromJson(data as UserInfoSpUserAuth, json) as T;			case GoodsResourceEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case UserInfoEntity:
			...
			return userInfoSpUserAuthToJson(data as UserInfoSpUserAuth);			case GoodsResourceEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'UserInfoEntity':
			...
			return UserInfoSpUserAuth().fromJson(json);			case 'GoodsResourceEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'UserInfoEntity':
			...
			return List<UserInfoSpUserAuth>();			case 'GoodsResourceEntity':
