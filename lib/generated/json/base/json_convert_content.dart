...
import 'package:cargo_flutter_app/generated/json/bill_entity_helper.dart';
...
import 'package:cargo_flutter_app/generated/json/driver_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case BillEntity:
			...
			return userInfoSpUserAuthFromJson(data as UserInfoSpUserAuth, json) as T;			case InvoiceEditInfoEntity:
			return invoiceEditInfoEntityFromJson(data as InvoiceEditInfoEntity, json) as T;			case DriverEntity:
			return driverEntityFromJson(data as DriverEntity, json) as T;			case InvoiceInfoEntity:
			return invoiceInfoEntityFromJson(data as InvoiceInfoEntity, json) as T;			case GoodsResourceEntity:
			return goodsResourceEntityFromJson(data as GoodsResourceEntity, json) as T;    }
    return data as T;
  }
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case BillEntity:
			...
			return userInfoSpUserAuthToJson(data as UserInfoSpUserAuth);			case InvoiceEditInfoEntity:
			return invoiceEditInfoEntityToJson(data as InvoiceEditInfoEntity);			case DriverEntity:
			return driverEntityToJson(data as DriverEntity);			case InvoiceInfoEntity:
			return invoiceInfoEntityToJson(data as InvoiceInfoEntity);			case GoodsResourceEntity:
			return goodsResourceEntityToJson(data as GoodsResourceEntity);    }
    return data as T;
  }
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'BillEntity':
			...
			return UserInfoSpUserAuth().fromJson(json);			case 'InvoiceEditInfoEntity':
			return InvoiceEditInfoEntity().fromJson(json);			case 'DriverEntity':
			return DriverEntity().fromJson(json);			case 'InvoiceInfoEntity':
			return InvoiceInfoEntity().fromJson(json);			case 'GoodsResourceEntity':
			return GoodsResourceEntity().fromJson(json);    }
    return null;
  }
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'BillEntity':
			...
			return List<UserInfoSpUserAuth>();			case 'InvoiceEditInfoEntity':
			return List<InvoiceEditInfoEntity>();			case 'DriverEntity':
			return List<DriverEntity>();			case 'InvoiceInfoEntity':
			return List<InvoiceInfoEntity>();			case 'GoodsResourceEntity':
			return List<GoodsResourceEntity>();    }
    return null;
  }
