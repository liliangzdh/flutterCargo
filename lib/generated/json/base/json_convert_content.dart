...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case GoodsResourceEntity:
			return goodsResourceEntityFromJson(data as GoodsResourceEntity, json) as T;			case UserInfoEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case GoodsResourceEntity:
			return goodsResourceEntityToJson(data as GoodsResourceEntity);			case UserInfoEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'GoodsResourceEntity':
			return GoodsResourceEntity().fromJson(json);			case 'UserInfoEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'GoodsResourceEntity':
			return List<GoodsResourceEntity>();			case 'UserInfoEntity':
